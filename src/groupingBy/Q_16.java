...
//Question: Group by department and for each department, get the employee with the longest name
...
public class Q_16 {
    ...
    public static void main(String [] args){
        ...
        Map<String, Employee>list = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment,
                        Collectors.collectingAndThen(Collectors.maxBy(Comparator.comparing(emp->emp.getName().length())), Optional::get)));
