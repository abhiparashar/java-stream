...
//Question: Group by department, but only include employees with salary > 70000, then count them
...
public class Q_15 {
    ...
    public static void main(String [] args){
        ...
        Map<String, Long>map = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment,Collectors.collectingAndThen(Collectors.toList(),list-> list.stream().filter(employee -> employee.getSalary()>70000).count())));
