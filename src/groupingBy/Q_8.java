...
//Question: Group by department but collect only employee names (not full objects)
...
public class Q_8 {
    ...
    public static void main(String [] args){
        ...
        Map<String , List<String >>map = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment,Collectors.mapping(employee -> employee.name, Collectors.toList())));
