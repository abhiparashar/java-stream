...
//Question 41: Get employee names grouped by department
public class Question_41 {
    ...
    public static void main(String[] args){
        ...
        Map<String, List<String>>listMap = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDept,Collectors.collectingAndThen(Collectors.mapping(Employee::getName, Collectors.toList()),list -> list)));
