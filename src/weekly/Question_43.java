...
//
////Question 43: Get salary ranges for each department
...
//        );
//        Map<String, String>list = employees.stream()
//                .collect(Collectors.groupingBy(Employee::getDept),Collectors.mapping());
//    }
//}
